...
${Array.from(room.jawaban, (jawaban, index) => {
	...
	if (tebaktebakan.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
        ...
        if (!isBotAdmins) return m.reply(`Yahh botnya ga admin :v`)
...
⭔ Penyedia Module.
⭔ Penyedia Rest Api's.
⭔ All My Friends (Terutama Fandyy Yang Telah Berbagi Ilmunya Ke Saya).
⭔ Sanzy YT (untuk beberapa fitur dan api).
⭔ Dan Pengguna BetaBotz MD.
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                listMessage :{
                    ...
                    footerText: "Gunakan Bot Dengan Bijak!",
                    ...
                    sections: [{
							...
							},
							{
								...
								"rows": [
									{
										"title": "Donasi",
										"description": "Donasi menampilkan fitur Donasi",
										"rowId": `${prefix}donasi`
									}
								]
							},
...
var messa = await prepareWAMessageMedia({ image: fs.readFileSync('./lib/hisoka.jpg') }, { upload: hisoka.waUploadToServer })
                var catalog = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                    ...
                    "product": {
                        ...
                        "retailerId": `Lann`,
                        "url": "wa.me/6285803583481"
                    },
                    "businessOwnerJid": "6285803583481@s.whatsapp.net",
                }
...
@${orang.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
	...
	break
case 'culik': {
if (args.length < 1) return m.reply('_*Masukin id grupnya Bang*_')
            let pantek = []
...
m.reply(mess.wait)
let anu = await getBuffer(`https://api.dapuhy.xyz/api/others/ssweb?url=${text}&apikey=betakey`)
...
m.reply(mess.wait)
                ...
                let random = anu[Math.floor(Math.random() * anu.length)]
                hisoka.sendMessage(m.chat, { image: { url: random.male }, caption: `Yang Ini Buat Cowoknya ${pushname} 🤵` }, { quoted: m })
                hisoka.sendMessage(m.chat, { image: { url: random.female }, caption: `Yang Ini Buat Ceweknya ${pushname} 👰` }, { quoted: m })
            }
	    break
            case 'wallpaper': {
...
if (!text) throw `Example : ${prefix + command} BetaBotz Kemren`
m.reply(mess.wait)
...
case 'balloons-love':
case 'bats-halloween': {
if (!text) throw `Example : ${prefix + command} LannOfc`
m.reply(mess.wait)
...
break
	    case 'nomerhoki': case 'nomorhoki': {
            ...
            break
                ...
                if (!text) throw 'Masukkan Query Link!'
                m.reply(mess.wait)
                let anu = await fetchJson(`https://betakey-api.herokuapp.com/docs/download/tiktok?url=${text}&apikey=betakey`)
                let buttons = [
...
break
case 'jadwalshalat': case 'jadwalsholat': case 'jadwal': {
if (!text) throw `Example : ${prefix + command} Pekanbaru`
m.reply(mess.wait)
let anu = await fetchJson(`https://api.lolhuman.xyz/api/sholat/${text}?apikey=sanzychan01`)
...
break
case 'cecan cina': case 'cina': case 'Cina': {
m.reply(mess.wait)
let buttons = [
                    {buttonId: `${prefix} cina`, buttonText: {displayText: 'Next⏩'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://api-betabot.herokuapp.com/api/cecan/china?apikey=BetaBotz' },
                    caption: `Cantik Kan Pacar ${pushname}`,
                    footer: hisoka.user.name,
                    buttons: buttons,
                    headerType: 4
                }
            ...
            break
case 'cecan vietnam': case 'vietnam': case 'Vietnam': {
m.reply(mess.wait)
let buttons = [
                    {buttonId: `${prefix} vietnam`, buttonText: {displayText: 'Next⏩'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://api-betabot.herokuapp.com/api/cecan/vietnam?apikey=BetaBotz' },
                    caption: `Cantik Kan Pacar ${pushname}`,
                    footer: hisoka.user.name,
                    buttons: buttons,
                    headerType: 4
            ...
            break
case 'cecan thailand': case 'thailand': case 'Thailand': {
m.reply(mess.wait)
m.reply(mess.wait)
let buttons = [
                    {buttonId: `${prefix} thailand`, buttonText: {displayText: 'Next⏩'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://api-betabot.herokuapp.com/api/cecan/thailand?apikey=BetaBotz' },
                    caption: `Cantik Kan Pacar ${pushname}`,
                    footer: hisoka.user.name,
                    buttons: buttons,
                    headerType: 4
            ...
            break
case 'cecan indonesia': case 'indonesia': case 'Indonesia': {
m.reply(mess.wait)
let buttons = [
                    {buttonId: `${prefix} indonesia`, buttonText: {displayText: 'Next⏩'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://api-betabot.herokuapp.com/api/cecan/indonesia?apikey=BetaBotz' },
                    caption: `Cantik Kan Pacar ${pushname}`,
                    footer: hisoka.user.name,
                    buttons: buttons,
                    headerType: 4
            ...
            break
case 'cecan korea': case 'korea': case 'Korea': {
m.reply(mess.wait)
let buttons = [
                    {buttonId: `${prefix} korea`, buttonText: {displayText: 'Next⏩'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://api-betabot.herokuapp.com/api/cecan/korea?apikey=BetaBotz' },
                    caption: `Cantik Kan Pacar ${pushname}`,
                    footer: hisoka.user.name,
                    buttons: buttons,
                    headerType: 4
            ...
            break
case 'cecan jepang': case 'jepang': case 'Jepang': case 'japan': {
m.reply(mess.wait)
let buttons = [
                    {buttonId: `${prefix} japan`, buttonText: {displayText: 'Next⏩'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://api-betabot.herokuapp.com/api/cecan/jepang?apikey=BetaBotz' },
                    caption: `Cantik Kan Pacar ${pushname}`,
                    footer: hisoka.user.name,
                    buttons: buttons,
                    headerType: 4
            ...
            break
case 'cecan malaysia': case 'malaysia': case 'Malaysia': {
m.reply(mess.wait)
let buttons = [
                    {buttonId: `${prefix} malaysia`, buttonText: {displayText: 'Next⏩'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://api-betabot.herokuapp.com/api/cecan/malaysia?apikey=BetaBotz' },
                    caption: `Cantik Kan Pacar ${pushname}`,
                    footer: hisoka.user.name,
                    buttons: buttons,
                    headerType: 4
...
m.reply(mess.wait)
	let buttons = [
                ...
                let buttonMessage = {
                    video: { url: 'https://api-betabot.herokuapp.com/api/asupan/bocil?apikey=BetaBotz' },
                    caption: `Nih Kak ${pushname} Jangan Sangee🙀`,
                    footer: hisoka.user.name,
                    buttons: buttons,
                    headerType: 4
                }
...
let buttons = [
                ...
                let buttonMessage = {
                    video: { url: 'https://api-betabot.herokuapp.com/api/asupan/santuy?apikey=BetaBotz' },
                    caption: `Nih Kak ${pushname} Jangan Sangee🙀`,
                    footer: hisoka.user.name,
                    buttons: buttons,
                    headerType: 4
...
let buttons = [
                ...
                let buttonMessage = {
                    video: { url: 'https://api-betabot.herokuapp.com/api/asupan/gheayubi?apikey=BetaBotz' },
                    caption: `Nih Kak ${pushname} Jangan Sangee🙀`,
                    footer: hisoka.user.name,
                    buttons: buttons,
                    headerType: 4
...
let buttons = [
                ...
                let buttonMessage = {
                    video: { url: 'https://api-betabot.herokuapp.com/api/asupan/ukhty?apikey=BetaBotz' },
                    caption: `Nih Kak ${pushname} Jangan Sangee🙀`,
                    footer: hisoka.user.name,
                    buttons: buttons,
                    headerType: 4
...
hisoka.sendMessage(m.chat, { video: anu, caption: `Nih Kak ${pushname} Jangan Sangee🙀` }, { quoted: ftroli})
}
case 'lolivid': {
m.reply(mess.wait)
let buttons = [
...
if (!text) throw `Example : ${prefix + command} LannOfc`
m.reply(mess.wait)
let anu = await getBuffer(`https://xteam.xyz/attp?file&text=${text}`)
...
if (!text) throw `Example : ${prefix + command} LannOfc`
m.reply(mess.wait)
let anu = await getBuffer(`https://xteam.xyz/tttp?file&text=${text}`)
hisoka.sendMessage(m.chat, { sticker: anu, caption: `Nih  Kak` }, { quoted: ftroli})
}
break
case 'tulis': case 'nulis': {
if (args.length < 1) return m.reply('Yang mau di tulis apaan?example:BetaBotz MD By Lann')
teks = args.join(' ')
                m.reply(mess.wait)
...
m.reply(mess.wait)
let anu = await getBuffer(`https://zenzapi.xyz/api/image/phcomment?image=https://i.ibb.co/KjSBWx4/Pics-Art-02-07-11-45-03.jpg&text=${text}&username=BETABOT&apikey=sanzychan01`)
hisoka.sendMessage(m.chat, { image: anu, caption: `Nih  Kak` }, { quoted: m})
}
break
case 'ytcomment': {
if (!text) throw `Example : ${prefix + command} Keren Sih`
m.reply(mess.wait)
let anu = await getBuffer(`https://zenzapi.xyz/api/image/ytcomment?image=https://i.ibb.co/KjSBWx4/Pics-Art-02-07-11-45-03.jpg&text=${text}&username=BetaBotz&apikey=sanzychan01`)
hisoka.sendMessage(m.chat, { image: anu, caption: `Nih  Kak` }, { quoted: m})
}
break
case 'kannagen': {
if (!text) throw `Exampel : ${prefix + command} BetaBotzMD`
...
Lihat list Pesan Dengan ${prefix}listmsg`)
	    ...
	    case 'anonymous': {
            ...
            case 'keluar': case 'leave': {
                ...
                m.reply('Berhasil Keluar Dari Anonymous')
            ...
            case 'public': {
                if (!isCreator) throw mess.owner
                hisoka.public = true
                m.reply('Sukses Mengubah Bot Ke Mode Publik😎')
            }
            break
            case 'self': {
                if (!isCreator) throw mess.owner
                hisoka.public = false
                m.reply('Sukses Mengubah Bot Ke Mode Self😎')
            }
            break
            case 'menu': case 'help': case 'lann': {
...
Bot Termux Yee`
                let button = [{
                                quickReplyButton: {
                                    displayText: 'Pembayaran/Payment',
                                    id: 'donasi'
                                }
                            }]
                hisoka.send5ButImg(m.chat, anu, hisoka.user.name, global.thumb, button)
            ...
            break
case 'pay': case 'donasi': {
	         anu = `Haii Kak ${pushname} Selamat ${salam}
Kalian Bisa Mendukung Bot Ini Dengan Cara Donasi Ya Ka🤗 Terimakasih `
              let button = [{
                                quickReplyButton: {
                                    displayText: 'SewaBot 🤖',
                                    id: 'sewabot'
                ...
                hisoka.send5ButImg(m.chat, anu, hisoka.user.name, fs.readFileSync('./lib/donasi.jpg'), button)
            }
            break
